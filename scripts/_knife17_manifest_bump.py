#!/usr/bin/env python3
"""Knife 17 bump script — add 4 peer-compare UI files + receipt 245.
...
NEW_ARTIFACTS = [
    (
        "frontend/lib/types_peer_compare.ts",
        "spike_helper",
    ),
    (
    ...
    (
        ...
        "245-stage0-cc-s29-lite-peer-compare-impl-receipt-20260826.md",
        "documentation",
    ),
]
