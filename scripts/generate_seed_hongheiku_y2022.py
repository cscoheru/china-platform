#!/usr/bin/env python3
"""665b generate_seed_hongheiku_timeseries_2022.py — build seed CSV from parse JSON.

Mirror 665a seed CSV schema (dbt seed format):
...
Sources:
  - evidence_pack/u6_batch_y2022_parse_20260904.json (extract 10 indicators per province)
  - evidence_pack/u6_batch_y2022_fetch_20260904.json (URL per province)

Output:
  dbt/seeds/seed_hongheiku_timeseries_2022.csv (~200 rows, only provinces with parse output)
"""
import csv
import json
...
# Province CN names (mirror 665a seed)
PROVINCE_NAME_CN = {
...
LINEAGE_RULING = 'knife_665_y2022'
