...
- rev: 63
- updated: 2026-09-01
- ruling: 638 DELIVERED → 639 M4.2 tasking **OPEN** → 等执行落地

## §CURRENT

- status: **639 tasking OPEN · 等 CC 落地**
- cc_head: `f57712f` (638 tasking) + `f1fdad5` (638 delivery) + `4123fcb` (638 cc_head) + `ee86977` (638 receipt) + `c3968ec` (639 tasking)
...
- last_delivery: `638-stage0-cc-m4-1-people-schema-gov-report-probe-receipt-20260901.md`
- m4_decision: 639 = M4.2（任免数据 demo：≤5 demo person + tenure + appointment_event is_demo=true 隔离 + 二次 probe）

## §NOW

CC 落地 639-A (二次 probe + seed SQL + docs/59 + EXEC-QUEUE rev63) + 639-B (≥6 用例) + 639-C (回执 + 双推)。
...
| 639 | **tasking OPEN** | M4.2 任免数据 demo (≤5 demo + is_demo=true 隔离) + 二次 probe (ccdi 公告列表 + npc 新 URL + 23 试点省任免栏目) |
