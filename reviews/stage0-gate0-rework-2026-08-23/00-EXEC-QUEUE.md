...
CC 落地 644-A.1 (M5 WAF 第三次 国务院 /zhengce/zhengceku/ + /zhengce/content_xxx.htm 真实 ID + /zwgk/ retry 路径 ≤10 HTTP) + 644-A.2 (M4.7 政策详情 3 试点省 hlj/henan/yunnan × 1 detail each 政策详情页 landing 真实抓取 ≤12 HTTP, 3 真实样本落地) + 644-A.3 (M4.7 seed SQL 18 INSERT lineage.is_demo='false', chain_id='real_644_m4_7_policy_detail', UUID c 段 ≠ 643 b 段) + 644-A.4 (docs/66 M5 + docs/67 M4.7 §1-§6 架构师级审查) + 644-A.5 (2 reports + 2 evidence JSONs) + 644-A.6 (EXEC-QUEUE rev73 bump) + 644-B (12 用例 = 6 M5 + 6 M4.7, 12/12 pytest green) + 644-C (回执 + 双推)。
...
| 644 | **tasking OPEN** | M5 WAF spike 第三次收口 (国务院 /zhengce/zhengceku/ + /zhengce/content_xxx.htm 真实 ID + /zwgk/ retry 路径 ≤10 HTTP) + M4.7 政策详情真实化 (复用 643 hlj/henan/yunnan × 1 detail each × 6 政策表 = 18 INSERT planned lineage.is_demo='false' chain_id='real_644_m4_7_policy_detail', UUID c 段 ≠ 643 b 段) 并行 spike
