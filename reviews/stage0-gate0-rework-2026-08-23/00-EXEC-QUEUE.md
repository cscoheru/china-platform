...
> **rev 53 · 2026-08-31。** 历史：`00-EXEC-QUEUE.archive-rev46-20260830.md`。
...
- rev: 53
- updated: 2026-08-31
- ruling: 用户授权入库双推；**M1 有限通过**；开 **M2**（首刀 631）
...
执行 **631（M2-a）**：31 省 geo 种子 + 2024 GDP 表级源清单 + 覆盖率空矩阵。  
禁：仅锁省统计局首页；补零；买库；宣布 M2/Gate PASS。
