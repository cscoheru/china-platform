...
// Note: BannerMode type is NOT re-exported here — direct callers should
// `import type { BannerMode } from "./env"` to avoid TS 5.5 bundler-resolution
// bugs when this re-export is mixed with other value re-exports below.
...
export { deriveBannerMode } from "./env";
