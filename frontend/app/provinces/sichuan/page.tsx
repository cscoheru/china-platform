// Stage 2 / S2.7-a2 — Sichuan provincial observation page (route shell).
//
...
export default async function ProvincePage() {
  // No params gate — this page IS the sichuan page by file path.
  const evidenceChain = getMockEvidenceChain("sichuan");
  if (!evidenceChain) {
    throw new Error("Evidence chain mock missing for sichuan");
  }
